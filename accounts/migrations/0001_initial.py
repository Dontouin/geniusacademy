...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(choices=[('Primary', 'Primaire'), ('Secondary', 'Secondaire'), ('High', 'Lycée')], max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation_ship', models.CharField(blank=True, choices=[('Père', 'Père'), ('Mère', 'Mère'), ('Frère', 'Frère'), ('Sœur', 'Sœur'), ('Grand-mère', 'Grand-mère'), ('Grand-père', 'Grand-père'), ('Autre', 'Autre')], max_length=50)),
